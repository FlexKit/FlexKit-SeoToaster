...
television="googletv viera smarttv internet.tv netcast nettv appletv boxee kylo roku dlnadoc roku pov_tv hbbtv ce-html".split(" ");for(a=0;a<television.length;){if(c(television[a]))return!0;a++}return!1};a.portrait=function(){return 1<window.innerHeight/window.innerWidth};a.landscape=function(){return 1>window.innerHeight/window.innerWidth};a.noConflict=function(){window.device=b;return this};c=function(a){return-1!==n.indexOf(a)};h=function(a){return e.className.match(new RegExp(a,"i"))};d=function(a){h(a)||
(e.className=e.className.trim()+" "+a)};m=function(a){h(a)&&(e.className=e.className.replace(" "+a,""))};if(a.ipad()||a.iphone()||a.ipod()||a.android()||a.blackberry()||a.windowsTablet()||a.windowsPhone()||a.fxos()||a.meego()||/tablet|mobile/i.test(document.body.className.substr(0)))a.type=!0;a.ios()?a.ipad()?d("ios ipad tablet"):a.iphone()?d("ios iphone mobile"):a.ipod()&&d("ios ipod mobile"):a.android()?a.androidTablet()?d("android tablet"):d("android mobile"):a.blackberry()?a.blackberryTablet()?
d("blackberry tablet"):d("blackberry mobile"):a.windows()?a.windowsTablet()?d("windows tablet"):a.windowsPhone()?d("windows mobile"):d("desktop"):a.fxos()?a.fxosTablet()?d("fxos tablet"):d("fxos mobile"):a.meego()?d("meego mobile"):a.nodeWebkit()?d("node-webkit"):a.television()?d("television"):a.desktop()&&d("desktop");a.cordova()&&d("cordova");g=function(){a.landscape()?(m("portrait"),d("landscape")):(m("landscape"),d("portrait"))};k=window.hasOwnProperty("onorientationchange")?"orientationchange":
